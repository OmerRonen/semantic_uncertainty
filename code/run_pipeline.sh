...
# run generation
/accounts/campus/omer_ronen/.conda/envs/lso/bin/python code/generate.py --num_generations_per_prompt='5' --model=$model --fraction_of_data_to_use='0.05' --run_id=$run_id --temperature='1' --num_beams='1' --top_p='1.0'
